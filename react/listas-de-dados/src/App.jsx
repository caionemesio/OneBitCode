...
// let gameComponents = []
// games.forEach(game => {
//   gameComponents.push(<p>{game.title}</p>)
// })
export default function App() {
  return (
    <div className="app" style={{padding:"0 4rem 4rem"}}>
      <h1>Meus Jogos</h1>
      <section style={{display:"flex", flexWrap:"wrap", gap:"4rem"}}>
        {games.map((game)=>(
                  <div key={game.id}>
                    <img src={game.coverImage} alt="" style={{width:"20rem", height:"30rem", objectFit:"cover"}} />
                    <h2>{game.title}</h2>
